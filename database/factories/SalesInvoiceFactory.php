...
class SalesInvoiceFactory extends Factory
{
    ...
    {
        return ['uuid' => (string) Str::uuid(), 'invoice_number' => 'INV-'.$this->faker->unique()->numerify('######'), 'invoice_type' => 'direct_sale', 'status' => 'draft', 'invoice_date' => today(), 'price_includes_tax' => false, 'subtotal' => 100, 'discount_value' => 0, 'discount_amount' => 0, 'tax_amount' => 14, 'rounding_amount' => 0, 'total' => 114, 'paid_amount' => 0, 'credited_amount' => 0, 'refunded_amount' => 0, 'balance_due' => 114, 'customer_name_snapshot' => $this->faker->name()];
    }
}
