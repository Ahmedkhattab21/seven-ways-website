...
@section('content')
<div class="sw-alert">لا توجد قيود محاسبية فعلية في Phase 14A.</div>
...
<input type="hidden" name="is_current" value="0"></div><button class="sw-btn">إنشاء سنة</button></form>@endif
